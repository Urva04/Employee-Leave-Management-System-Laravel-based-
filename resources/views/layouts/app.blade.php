...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="{{ route('employee.leave-requests.create') }}" class="nav-link {{ request()->routeIs('employee.leave-requests.create') ? 'active' : '' }}">
                ...
                <div class="dropdown">
                    <a href="#" class="d-flex align-items-center gap-2 text-decoration-none dropdown-toggle" data-bs-toggle="dropdown">
                        ...
                        <div class="d-none d-md-block">
                            ...
                            <div style="font-size:0.7rem;color:#64748b">{{ ucfirst(auth()->user()->role) }}</div>
                        </div>
                    </a>
